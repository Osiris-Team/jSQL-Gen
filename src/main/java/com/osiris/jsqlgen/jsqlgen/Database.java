...
public static final TableMetaData[] tables = new TableMetaData[]{new TableMetaData(594, 2, 0, "Timer", new String[]{"id", "start", "end"}, new String[]{"INT AUTO_INCREMENT NOT NULL PRIMARY KEY", "DATETIME NOT NULL", "DATETIME NOT NULL"}, new String[]{"", "", ""}){public Class<?> getTableClass(){return Timer.class;}public List<Database.Row> get(){List<Database.Row> l = new ArrayList<>(); for(Timer obj : Timer.get()) l.add(obj); return l;}public Database.Row get(Object id){return Timer.get((int) id);}public void update(Database.Row obj){Timer.update((Timer)obj);}public Database.Row createWithNulls(){ return Timer.create(null, null);}public void add(Database.Row obj){Timer.add((Timer)obj);}public void remove(Database.Row obj){Timer.remove((Timer)obj);}}, new TableMetaData(598, 2, 0, "TimerTask", new String[]{"id", "timerId", "taskId", "percentageOfTimer", "changelog"}, new String[]{"INT AUTO_INCREMENT NOT NULL PRIMARY KEY", "INT NOT NULL", "INT NOT NULL", "DOUBLE NOT NULL", "TEXT DEFAULT ''"}, new String[]{"", "", "", "0-100%", ""}){public Class<?> getTableClass(){return TimerTask.class;}public List<Database.Row> get(){List<Database.Row> l = new ArrayList<>(); for(TimerTask obj : TimerTask.get()) l.add(obj); return l;}public Database.Row get(Object id){return TimerTask.get((int) id);}public void update(Database.Row obj){TimerTask.update((TimerTask)obj);}public Database.Row createWithNulls(){ return TimerTask.create(defaultInMemoryOnlyObjId, defaultInMemoryOnlyObjId, 0);}public void add(Database.Row obj){TimerTask.add((TimerTask)obj);}public void remove(Database.Row obj){TimerTask.remove((TimerTask)obj);}}, new TableMetaData(601, 2, 0, "Task", new String[]{"id", "name"}, new String[]{"INT AUTO_INCREMENT NOT NULL PRIMARY KEY", "TEXT DEFAULT 'New Task'"}, new String[]{"", ""}){public Class<?> getTableClass(){return Task.class;}public List<Database.Row> get(){List<Database.Row> l = new ArrayList<>(); for(Task obj : Task.get()) l.add(obj); return l;}public Database.Row get(Object id){return Task.get((int) id);}public void update(Database.Row obj){Task.update((Task)obj);}public Database.Row createWithNulls(){ return Task.create();}public void add(Database.Row obj){Task.add((Task)obj);}public void remove(Database.Row obj){Task.remove((Task)obj);}}, new TableMetaData(377336, 3, 0, "FakeFile", new String[]{"id", "parentFakeFileId", "hours", "maxHours", "name", "commitSha", "commitTime"}, new String[]{"INT AUTO_INCREMENT NOT NULL PRIMARY KEY", "INT DEFAULT -1", "INT DEFAULT 0", "INT DEFAULT 0", "LONGTEXT DEFAULT ''", "TEXT DEFAULT ''", "DATETIME DEFAULT NULL"}, new String[]{"", "", "", "", "", "", ""}){public Class<?> getTableClass(){return FakeFile.class;}public List<Database.Row> get(){List<Database.Row> l = new ArrayList<>(); for(FakeFile obj : FakeFile.get()) l.add(obj); return l;}public Database.Row get(Object id){return FakeFile.get((int) id);}public void update(Database.Row obj){FakeFile.update((FakeFile)obj);}public Database.Row createWithNulls(){ return FakeFile.create();}public void add(Database.Row obj){FakeFile.add((FakeFile)obj);}public void remove(Database.Row obj){FakeFile.remove((FakeFile)obj);}}, new TableMetaData(379877, 2, 0, "Global", new String[]{"id", "githubToken", "lastRepo", "isTotalCountRecursive"}, new String[]{"INT AUTO_INCREMENT NOT NULL PRIMARY KEY", "TEXT DEFAULT ''", "TEXT DEFAULT ''", "BOOLEAN DEFAULT TRUE"}, new String[]{"", "", "", ""}){public Class<?> getTableClass(){return Global.class;}public List<Database.Row> get(){List<Database.Row> l = new ArrayList<>(); for(Global obj : Global.get()) l.add(obj); return l;}public Database.Row get(Object id){return Global.get((int) id);}public void update(Database.Row obj){Global.update((Global)obj);}public Database.Row createWithNulls(){ return Global.create();}public void add(Database.Row obj){Global.add((Global)obj);}public void remove(Database.Row obj){Global.remove((Global)obj);}}, new TableMetaData(384785, 2, 0, "Tag", new String[]{"id", "name", "cssColor"}, new String[]{"INT AUTO_INCREMENT NOT NULL PRIMARY KEY", "TEXT DEFAULT ''", "TEXT DEFAULT ''"}, new String[]{"", "", ""}){public Class<?> getTableClass(){return Tag.class;}public List<Database.Row> get(){List<Database.Row> l = new ArrayList<>(); for(Tag obj : Tag.get()) l.add(obj); return l;}public Database.Row get(Object id){return Tag.get((int) id);}public void update(Database.Row obj){Tag.update((Tag)obj);}public Database.Row createWithNulls(){ return Tag.create();}public void add(Database.Row obj){Tag.add((Tag)obj);}public void remove(Database.Row obj){Tag.remove((Tag)obj);}}, new TableMetaData(384789, 2, 0, "TagEntry", new String[]{"id", "fakeFileId", "tagId"}, new String[]{"INT AUTO_INCREMENT NOT NULL PRIMARY KEY", "INT NOT NULL", "INT NOT NULL"}, new String[]{"", "", ""}){public Class<?> getTableClass(){return TagEntry.class;}public List<Database.Row> get(){List<Database.Row> l = new ArrayList<>(); for(TagEntry obj : TagEntry.get()) l.add(obj); return l;}public Database.Row get(Object id){return TagEntry.get((int) id);}public void update(Database.Row obj){TagEntry.update((TagEntry)obj);}public Database.Row createWithNulls(){ return TagEntry.create(defaultInMemoryOnlyObjId, defaultInMemoryOnlyObjId);}public void add(Database.Row obj){TagEntry.add((TagEntry)obj);}public void remove(Database.Row obj){TagEntry.remove((TagEntry)obj);}}};
